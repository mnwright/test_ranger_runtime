...
\usepackage{booktabs}
\usepackage[a4paper, top = 4cm, bottom = 2cm]{geometry}
...
## Measure runtime
tab <- measure_runtime(dats, scenarios, dependent.variable.name = "y", respect.unordered.factors = "order")
...
<<class_binary, echo = FALSE, results = "asis", cache = TRUE, warning = FALSE>>=
## Scenarios
scenarios <- list(c(n = 100, p = 5), 
                  c(n = 100, p = 50), 
                  c(n = 100, p = 500), 
...
<<class_cont, echo = FALSE, results = "asis", cache = TRUE, warning = FALSE>>=
## Scenarios
scenarios <- list(c(n = 100, p = 5), 
                  c(n = 100, p = 50), 
                  c(n = 100, p = 500), 
...
\subsection{Binary data}
<<prob_binary, echo = FALSE, results = "asis", cache = TRUE, warning = FALSE>>=
## Scenarios
scenarios <- list(c(n = 100, p = 5), 
                  c(n = 100, p = 50), 
                  c(n = 100, p = 500), 
...
\subsection{Continuous data}
<<prob_cont, echo = FALSE, results = "asis", cache = TRUE, warning = FALSE>>=
## Scenarios
scenarios <- list(c(n = 100, p = 5), 
                  c(n = 100, p = 50), 
                  c(n = 100, p = 500), 
...
\subsection{Binary data}
<<reg_binary, echo = FALSE, results = "asis", cache = TRUE, warning = FALSE>>=
## Scenarios
scenarios <- list(c(n = 100, p = 5), 
                  c(n = 100, p = 50), 
                  c(n = 100, p = 500), 
...
\subsection{Continuous data}
<<reg_cont, echo = FALSE, results = "asis", cache = TRUE, warning = FALSE>>=
## Scenarios
scenarios <- list(c(n = 100, p = 5), 
                  c(n = 100, p = 50), 
                  c(n = 100, p = 500), 
...
\section{Survival}
\subsection{Digit data}
<<surv_digit, echo = FALSE, results = "asis", cache = TRUE, warning = FALSE>>=
## Scenarios
scenarios <- list(c(n = 100, p = 5), 
                  c(n = 100, p = 50), 
                  c(n = 100, p = 500), 
...
\subsection{Binary data}
<<surv_binary, echo = FALSE, results = "asis", cache = TRUE, warning = FALSE>>=
## Scenarios
scenarios <- list(c(n = 100, p = 5), 
                  c(n = 100, p = 50), 
                  c(n = 100, p = 500), 
...
\subsection{Continuous data}
<<surv_cont, echo = FALSE, results = "asis", cache = TRUE, warning = FALSE>>=
## Scenarios
scenarios <- list(c(n = 100, p = 5), 
                  c(n = 100, p = 50), 
                  c(n = 100, p = 500))
